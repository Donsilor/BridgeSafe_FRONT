<template>
  <div>
    <el-input placeholder="请选择" :disabled="disabled" :size="size" :readonly="true" style="line-hight:40px"
    ...
    <el-dialog
      ...
      <el-row :gutter="15">
        <el-col :span="19">
          <el-form :inline="true" ref="searchForm" class="query-form" @keyup.enter.native="refreshList()"
  ...
  export default {
    ...
    methods: {
        ...
        this.$http({
          ...
          if (data && data.success) {
            if (data.page) {
              ...
              this.total = data.treeData.length
            }
            this.loading = false
          }
          this.$nextTick(() => {
      ...
      doSubmit() {
        ...
        let value = this.dataListAllSelections.map((item) => {
