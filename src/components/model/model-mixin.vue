<template>
  <div style="width: 100%;height: 100%;margin: 0; border: 0; padding: 0;outline: none;">
...
<script>
  ...
  import { getSize, getCenter } from '@/utils/threeUtil'
  ...
  export default {
    ...
    computed: {
      hasListener () {
        ...
        const result = {}
        const arrary = ['on-mousemove', 'on-mouseup', 'on-mousedown', 'on-click']
    ...
    mounted () {
      ...
      this.scene.background = new Color('#0D112E')
      this.load()
      this.update()
