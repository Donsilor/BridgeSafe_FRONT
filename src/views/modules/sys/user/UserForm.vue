      ...
      <el-row :gutter="15">
        ...
        <el-col :span="12">
          <el-form-item label="公司" prop="company.id">
            <el-select v-model="inputForm.company.id" style="width: 100%" placeholder="请选择" @change="companyChange">
        ...
        <el-col :span="12">
          <el-form-item label="部门" prop="office.id">
            <el-select v-model="inputForm.office.id" style="width: 100%" placeholder="请选择">
        ...
        <el-col :span="12">
          <el-form-item label="密码:" prop="newPassword" :rules="inputForm.id ? [] : [{ required: true, message: '密码不能为空', trigger: 'blur' }]">
            <el-input v-model="inputForm.newPassword" maxlength="50" placeholder="请输入密码"></el-input>
          </el-form-item>
        </el-col>
        <!-- <el-col :span="12">
        ...
        <!-- <el-col :span="12">
          <el-form-item label="状态" prop="loginFlag">
            <el-radio-group v-model="inputForm.loginFlag">
              <el-radio v-for="item in this.$dictUtils.getDictList('enable_status')" :label="item.value" :key="item.id">{{ item.label }}</el-radio>
            </el-radio-group>
          </el-form-item>
        </el-col> -->
        <el-col :span="12">
  ...
  methods: {
    init(method, id) {
      ...
      this.$nextTick(() => {
        ...
        this.$http({
          url: `/sys/office/getCompany`,
        }).then(({ data }) => {
          this.companyList = data.companyList;
          if (method === 'add') {
            // 新增时带出选择的公司数据
            this.inputForm.company = {
              id: id.company.id || '',
            };
            // this.inputForm.office = {
            //   id: id.office.id || '',
            // };
            this.companyChange(this.inputForm.company.id);
          }
        });
        // this.$http({
