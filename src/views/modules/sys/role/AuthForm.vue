<template>
  <el-dialog title="权限设置" :close-on-click-modal="false" v-dialogDrag width="350px" :visible.sync="visible">
    <el-form class="auth" :model="inputForm" status-icon v-loading="loading" ref="inputForm" @keyup.enter.native="inputFormSubmit()" @submit.native.prevent>
