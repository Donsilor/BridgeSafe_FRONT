...
let myMap = new Map();
myMap.set("10001", "参数错误\t参数为空或格式不正确")
 myMap.set("10002", "accessToken异常或过期\t重新获取accessToken")
 myMap.set("10005", "appKey异常\tappKey被冻结")
 myMap.set("20002", "设备不存在")
 myMap.set("20014", "deviceSerial不合法")
 myMap.set("20018", "该用户不拥有该设备\t检查设备是否属于当前账户")
 myMap.set("49999", "数据异常\t接口调用异常")
